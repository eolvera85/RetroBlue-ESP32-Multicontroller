    ...
    switch (offset_address)
    {
        ...
        case 0x60:
            ...
            {   
                ...
                case 0x12: //Default always Pro Controller Values
                    return 0x03; //ns_controller_data.controller_type_primary;
                    break;

                // Unknown constant
                case 0x13: //Default always Pro Controller Values
                    return 0x02; //ns_controller_data.controller_type_secondary;
                    //return 0xA0;
                    break;
